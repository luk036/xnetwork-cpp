...
namespace fun {
    ...
    template <typename Z> struct Fraction {
        ...
        constexpr _Self operator+(const _Self& frac) const {
            ...
            const auto n
                = common / _denominator * _numerator + common / frac._denominator * frac._numerator;
         ...
         * @return false
         */
        template <typename U> constexpr bool operator==(const Fraction<U>& frac) const {
            if (_denominator == frac._denominator) {
                return _numerator == frac._numerator;
            }
         ...
         * @return _Stream&
         */
        template <typename _Stream> friend _Stream& operator<<(_Stream& os, const _Self& frac) {
