...
from xnetwork.classes
    .graph import Graph  // for doctests
        from xnetwork.classes.digraph import DiGraph from xnetwork.classes.multigraph import
            MultiGraph
    ...
    **Subclasses (Advanced) {**
                            ...
                            if (v not : this->_succ) {
                                ...
                                if (key.empty()) {
                                    ...
                                    if (v : this->_succ[u]) {
                                        ...
                                        keydict[key] = datadict;
                                        this->_succ[u][v] = keydict this->_pred[v][u]
                                            = keydict return key
                                            ...
                                            key : hashable identifier, optional (default=None);
                                                Used to distinguish multiple edges between a pair of
                                            nodes. If None remove a single (arbitrary) edge between
                                            u && v.
                                            ...
                                            key_list returned [0, 1, 2];
                                            >>> G.remove_edge(1, 2) // remove a single (arbitrary)
                                            edge
                                            ...
                                            try {
                                                ...
                                                if (key.empty()) {
                                                    ...
                                                    try {
                                                        ...
                                                        const auto msg
                                                            = "The edge %s-%s with key %s is not : "
                                                              "the graph." throw XNetworkError(
                                                                  msg % (u, v, key));
                                                        if (len(d) == 0) {
                                                            ...
                                                            auto edges() {
                                                                ...
                                                                keys=false, default=None);

                                                                The OutMultiEdgeView provides
                                                                set-like operations on the
                                                                edge-tuples as well as edge
                                                                attribute lookup. When called, it
                                                                also provides an EdgeDataView object
                                                                which allows control of access to
                                                                edge attributes (but does not
                                                                provide set-like operations). Hence,
                                                                `G.edges[u, v]["color"]` provides
                                                                the value of the color attribute for
                                                                edge `(u, v)` while `for (auto u, v,
                                                                c] : G.edges(data="color",
                                                                default="red") {` iterates through
                                                                all the edges yielding the color
                                                                attribute with default `"red"` if
                                                                (no color attribute exists.

                                                                Edges are returned as tuples with
                                                                optional data && keys : the order
                                                                (node, neighbor, key, data).

                                                                Parameters
                                                                ----------
                                                                nbunch : single node, container, ||
                                                                all nodes (default= all nodes); The
                                                                view will only report edges incident
                                                                to these nodes. data : string ||
                                                                bool, optional (default=false); The
                                                                edge attribute returned : 3-tuple
                                                                (u, v, ddict[data]). If true, return
                                                                edge attribute dict : 3-tuple (u, v,
                                                                ddict). If false, return 2-tuple (u,
                                                                v). keys : bool, optional
                                                                (default=false); If true, return
                                                                edge keys with each edge. default :
                                                                value, optional (default=None);
                                                                    Value used for edges that don"t
                                                                have the requested attribute. Only
                                                                relevant if (data is not true ||
                                                                false.

                                                                Returns
                                                                -------
                                                                edges : EdgeView
                                                                    A view of edge attributes,
                                                                usually it iterates over (u, v); (u,
                                                                v, k) || (u, v, k, d) tuples of
                                                                edges, but can also be used for
                                                                attribute lookup as `edges[u, v,
                                                                k]["foo"]`.

                                                                Notes
                                                                -----
                                                                Nodes : nbunch that are not : the
                                                                graph will be (quietly) ignored. For
                                                                directed graphs this returns the
                                                                out-edges.
                                                                ...
                                                                in_edges, out_edges
                                                                 */
                                                                this->__dict__["edges"] = edges
                                                                    = OutMultiEdgeView();
                                                                this->__dict__["out_edges"]
                                                                    = edges return edges;
                                                                ...
                                                                out_edges = edges
                                                                    ...
                                                                    auto
                                                                    in_edges() {
                                                                    /** An InMultiEdgeView of the
                                                                    Graph as G.in_edges ||
                                                                    G.in_edges().

                                                                    in_edges( nbunch=None,
                                                                    data=false, keys=false,
                                                                    default=None);

                                                                    Parameters
                                                                    ----------
                                                                    nbunch : single node, container,
                                                                    || all nodes (default= all
                                                                    nodes); The view will only
                                                                    report edges incident to these
                                                                    nodes. data : string || bool,
                                                                    optional (default=false); The
                                                                    edge attribute returned :
                                                                    3-tuple (u, v, ddict[data]). If
                                                                    true, return edge attribute dict
                                                                    : 3-tuple (u, v, ddict). If
                                                                    false, return 2-tuple (u, v).
                                                                    keys : bool, optional
                                                                    (default=false); If true, return
                                                                    edge keys with each edge.
                                                                    default : value, optional
                                                                    (default=None); Value used for
                                                                    edges that don"t have the
                                                                    requested attribute. Only
                                                                    relevant if (data is not true ||
                                                                    false.
                                                                    ...
                                                                    in_edges : InMultiEdgeView
                                                                        A view of edge attributes,
                                                                    usually it iterates over (u, v);
                                                                        || (u, v, k) || (u, v, k, d)
                                                                    tuples of edges, but can also be
                                                                        used for attribute lookup as
                                                                    `edges[u, v, k]["foo"]`.
                                                                    ...
                                                                    return in_edges
                                                                        ...
                                                                        auto
                                                                        degree() {
                                                                        /** A DegreeView for the
                                                                        Graph as G.degree ||
                                                                        G.degree().

                                                                        The node degree is the
                                                                        number of edges adjacent to
                                                                        the node. The weighted node
                                                                        degree is the sum of the
                                                                        edge weights for edges
                                                                        incident to that node.

                                                                        This object provides an
                                                                        iterator for (auto node,
                                                                        degree) as well as lookup
                                                                        for the degree for a single
                                                                        node.
                                                                        ...
                                                                        nbunch : single node,
                                                                        container, || all nodes
                                                                        (default= all nodes); The
                                                                        view will only report edges
                                                                        incident to these nodes.

                                                                        weight : string || None,
                                                                        optional (default=None); The
                                                                        name of an edge attribute
                                                                        that holds the numerical
                                                                        value used as a weight.  If
                                                                        None, then each edge has
                                                                        weight 1. The degree is the
                                                                        sum of the edge weights
                                                                        adjacent to the node.

                                                                        Returns
                                                                        -------
                                                                        If a single nodes is
                                                                        requested deg : int Degree
                                                                        of the node

                                                                        OR if (multiple nodes are
                                                                        requested nd_iter : iterator
                                                                        ...
                                                                        auto in_degree() {
                                                                            /** A DegreeView for
                                                                            (auto node, in_degree)
                                                                            || in_degree for single
                                                                            node.

                                                                            The node in-degree is
                                                                            the number of edges
                                                                            ...
                                                                            If None, then each edge
                                                                            has weight 1. The degree
                                                                            is the sum of the edge
                                                                            weights adjacent to the
                                                                            node.
                                                                            ...
                                                                            OR if (multiple nodes
                                                                            are requested nd_iter :
    ...
    auto subgraph( nodes) {
        ...
        if (hasattr( "_NODE_OK") {
            ...
            return H return xn::graphviews.MultiReverseView();
