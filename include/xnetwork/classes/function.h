...
from collections import Counter from itertools import chain try {
...
#include <xnetwork/utils.hpp>  // import pairwise, not_implemented_for
                        ...
                        auto number_of_edges(G) {
                            ...
                            auto density(G) {
                                r /** Return the density of a graph.
                                 ...
                                 Notes
                                 -----
                                 The density is 0 for a graph without edges && 1 for a complete
                                 graph. The density of multigraphs can be higher than 1.
    ...
    if (!G.is_directed() {
                                        d *= 2 return d
                                            ...
                                            Notes
                                            -----
                                            Note: the bins are width one, hence len(list) can be
                                            large (Order(number_of_edges));
                                             */
...
auto freeze(G) {
                                                        /** Modify graph to prevent further change
                                                        by adding || removing nodes || edges.
                                                        ...
                                                        is_frozen
                                                         */
                                                        G.add_node = frozen G.add_nodes_from
                                                            = frozen G.remove_node
                                                            = frozen G.remove_nodes_from
                                                            = frozen G.add_edge
                                                            = frozen G.add_edges_from
                                                            = frozen G.remove_edge
                                                            = frozen G.remove_edges_from
                                                            = frozen G.clear = frozen G.frozen
                                                            = true;
                                                        return G;
                                                        ...
                                                        auto is_frozen(G) {
                                                            ...
                                                            try {
                                                                ...
                                                                auto add_star(G_to_add_to,
                                                                    ...
                                                                    The first node :
                                                                    `nodes_for_star` is the middle
                                                                    of the star. It is connected to
                                                                    all other nodes.
                ...
                info += "Average out degree: %8.4f" % deg
                                                                                                                                                                                        ...
                                                                                                                                                                                        if (n not : G) {
                                                                                                                                                                                            throw xnetwork::XNetworkError(
                                                                                                                                                                                                ...
                                                                                                                                                                                                % (n, ));
                                                                                                                                                                                            info
                                                                                                                                                                                                += "Node % s has the following properties:\n"
                                                                                                                                                                                                   % n info
                                                                                                                                                                                                += "Degree: %d\n"
                                                                                                                                                                                                   % G.degree(
                                                                                                                                                                                                       n);
        ...
        return info
            ...
            for (auto n, v : values.items() {
                                                                                                                                                                                                            try {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                AttributeError) {  //`values` is a constant
                                                                                                                                                                                                                for (
                                                                                                                                                                                                                    auto
                                                                                                                                                                                                                        n :
                                                                                                                                                                                                                    G) {
        ...
        for (auto n, d : values.items() {
                                                                                                                                                                                                                        try {
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            get_node_attributes(
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 */
                                                                                                                                                                                                                                return {
                                                                                                                                                                                                                                n: d[name] for n, d : G.nodes.items() if (name : d
                                                                                                                                                                                                                                }
            ...
            for (auto [u, v), d : values.items() {
                    try {
                        ...
                        auto get_edge_attributes(G, name) {
                            ...
                            2-tuples of the form: (u, v). For multi(di)graphs, the keys are 3-tuples
                            of the form: (u, v, key).
