    ...
    **Subclasses (Advanced) {**
    ...
    explicit _Self(incoming_graph_data = None, **attr) {
        ...
        if (u not : this->_adj) {
                                ...
                                if (v not : this->_adj) {
                                    ...
                                    if (key.empty()) {
                                        ...
                                        if (v : this->_adj[u]) {
                                            keydict = this->_adj[u][v];
                                            datadict
                                                = keydict.get(key, this->edge_attr_dict_factory());
                                            ...
                                            keydict[key] = datadict;
                                            this->_adj[u][v] = keydict this->_adj[v][u]
                                                = keydict return key
                                                ...
                                                ebunch_to_add : container of edges
                                                    Each edge given : the container will be added to
                                                the graph. The edges can be) {

                                                        - 2-tuples (u, v) or
                                                        - 3-tuples (u, v, d) for an edge data dict
                                                d, or
                                                        - 3-tuples (u, v, k) for not iterable key k,
                                                or
                                                        - 4-tuples (u, v, k, d) for an edge with
                                                data && key k

                                                attr : keyword arguments, optional
                                                    Edge data (or labels || objects) can be assigned
                                                using keyword arguments.

                                                Returns
                                                -------
                                                A list of edge keys assigned to the edges :
                                                `ebunch`.

                                                See Also
                                                --------
                                                add_edge : add a single edge
                                                add_weighted_edges_from : convenient way to add
                                                weighted edges

                                                Notes
                                                -----
                                                Adding the same edge twice has no effect but any
                                                edge data will be updated when each duplicate edge
                                                is added.

                                                Edge attributes specified : an ebunch take
                                                precedence over attributes specified via keyword
                                                arguments.

                                                Default keys are generated using the method
                                                ``new_edge_key()``. This method can be overridden by
                                                subclassing the base class && providing a custom
                                                ``new_edge_key()`` method.
                                                ...
                                                MultiDiGraph, etc
                                                >>> G.add_edges_from([(0, 1), (1, 2)]) // using a
                                                list of edge tuples
                                                >>> e = zip(range(0, 3), range(1, 4));
                                                >>> G.add_edges_from(e) // Add the path graph
                                                0-1-2-3
                                                ...
                                                for (auto e : ebunch_to_add) {
                                                    ...
                                                    if (ne == 4) {
                                                        ...
                                                        const auto msg
                                                            = "Edge tuple {} must be a 2-tuple, "
                                                              "3-tuple || "
                                                              "4-tuple." throw XNetworkError(
                                                                  msg.format(e));
                                                        ddd = {};
                                                        ddd.update(attr);
                                                        try {
                ...
                if (ne != 3) {
                    throw;
                    key = dd key = this->add_edge(u, v, key);
                        ...
                        try {
                            ...
                            if (key.empty()) {
                                ...
                                try {
                                    ...
                                    const auto msg
                                        = "The edge %s-%s with key %s is not : the "
                                          "graph." throw XNetworkError(msg % (u, v, key));
                                    if (len(d) == 0) {
                                        ...
                                        if (u != v) {  // check for selfloop
                                            ...
                                            auto remove_edges_from(ebunch) {
                                                ...
                                                ebunch: list || container of edge tuples
                                                    Each edge given : the list || container will be
                                                removed from the graph. The edges can be) {

                                                        - 2-tuples (u, v) All edges between u && v
                                                are removed.
                                                        - 3-tuples (u, v, key) The edge identified
                                                by key is removed.
                                                        - 4-tuples (u, v, key, data) where data is
                                                ignored.
                                                ...
                                                Notes
                                                -----
                                                Will fail silently if (an edge : ebunch is not : the
                                                graph.

                                                Examples
                                                --------
                                                >>> G = xn::path_graph(4);  // or DiGraph,
                                                ...
                                                >>> G = xn::MultiGraph();
                                                >>> keys = G.add_edges_from([(1, 2), (1, 2), (1,
                                                2)]);
                                                >>> G.remove_edges_from([(1, 2), (1, 2)]);
                                                >>> list(G.edges());
                                                [(1, 2)];
                                                >>> G.remove_edges_from([(1, 2), (1, 2)]) //
                                                silently ignore extra copy
                                                ...
                                                for (auto e : ebunch) {
                                                    try {
                                                        ...
                                                        auto has_edge(u, v, key = None) {
                                                            /** Return true if (the graph has an
                                                            edge between nodes u && v.

                                                            This is the same as `v : G[u] || key :
                                                            G[u][v]` without KeyError exceptions.

                                                            Parameters
                                                            ----------
                                                            u, v : nodes
                                                                Nodes can be, for example, strings
                                                            || numbers.

                                                            key : hashable identifier, optional
                                                            (default=None); If specified return true
                                                            only if (the edge with key is found.

                                                            Returns
                                                            -------
                                                            edge_ind : bool
                                                                true if (edge is : the graph, false
                                                            otherwise.

                                                            Examples
                                                            --------
                                                            Can be called either using two nodes u,
                                                            v, an edge tuple (u, v),
                                                            ...
                                                            MultiDiGraph
                                                            >>> xn::add_path(G, [0, 1, 2, 3]);
                                                            >>> G.has_edge(0, 1);  // using two
                                                            nodes true
                                                            >>> e = (0, 1);
                                                            >>> G.has_edge(*e);  //  e is a 2-tuple
                                                            (u, v); true
                                                            >>> G.add_edge(0, 1, key="a");
                                                            "a";
                                                            >>> G.has_edge(0, 1, key="a");  //
                                                            specify key true
                                                            >>> e=(0, 1, "a");
                                                            >>> G.has_edge(*e) // e is a 3-tuple (u,
                                                            v, "a"); true
                                                            ...
                                                            >>> G.has_edge(0, 1);
                                                            true
                                                            >>> 1 : G[0];  // though this gives
                                                            :exc:`KeyError` if (0 not : G true
                                                            ...
                                                            try {
                                                                if (key.empty()) {
                                                                    ...
                                                                    auto edges() {
                                                                        ...
                                                                        The EdgeView provides
                                                                        set-like operations on the
                                                                        edge-tuples as well as edge
                                                                        attribute lookup. When
                                                                        called, it also provides an
                                                                        EdgeDataView object which
                                                                        allows control of access to
                                                                        edge attributes (but does
                                                                        not provide set-like
                                                                        operations). Hence,
                                                                        `G.edges[u, v]["color"]`
                                                                        provides the value of the
                                                                        color attribute for edge
                                                                        `(u, v)` while `for (auto u,
                                                                        v, c] :
                                                                        G.edges(data="color",
                                                                        default="red") {` iterates
                                                                        through all the edges
                                                                        yielding the color
                                                                        attribute.

                                                                        Edges are returned as tuples
                                                                        with optional data && keys
                                                                        : the order (node, neighbor,
                                                                        key, data).
                                                                        ...
                                                                        optional (default=false);
                                                                            The edge attribute
                                                                        returned : 3-tuple (u, v,
                                                                        ddict[data]). If true,
                                                                        return edge attribute dict :
                                                                        3-tuple (u, v, ddict). If
                                                                        false, return 2-tuple (u,
                                                                        v). keys : bool, optional
                                                                        (default=false); If true,
                                                                        return edge keys with each
                                                                        edge. default : value,
                                                                        optional (default=None);
                                                                            Value used for edges
                                                                        that don"t have the
                                                                        requested attribute. Only
                                                                        relevant if (data is not
                                                                        true || false.
                                                                        ...
                                                                        edges : MultiEdgeView
                                                                            A view of edge
                                                                        attributes, usually it
                                                                        iterates over (u, v); auto
                                                                        [u, v, k) || (u, v, k, d)
                                                                        tuples of edges, but can
                                                                        also be used for attribute
                                                                        lookup as `edges[u, v,
                                                                        k]["foo"]`.

                                                                        Notes
                                                                        -----
                                                                        Nodes : nbunch that are not
                                                                        : the graph will be
                                                                        (quietly) ignored. For
                                                                        directed graphs this returns
                                                                        the out-edges.
                                                                        ...
                                                                        auto get_edge_data(
                                                                            ...
                                                                            Warning: we protect the
                                                                            graph data structure by
                                                                            making `G.edges` &&
                                                                            `G[1][2]` read-only
                                                                            ...
                                                                            "a"]` || `G[1][2]["a"]`
                                                                            using an additional
                                                                            bracket as shown next.
                                                                            You need to specify all
                                                                            edge info to assign to
                                                                            the edge data associated
                                                                            with an edge.
