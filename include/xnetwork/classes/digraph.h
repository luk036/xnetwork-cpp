    ...
    **Subclasses (Advanced) {**
                            ...
                            if ("in_degree" : attr) {
                                ...
                                if ("out_degree" : attr) {
                                    ...
                                    return attr
                                        ...
                                        /** Initialize a graph with edges, name, || graph
                                        attributes.
                                        ...
                                        incoming_graph_data : input graph (optional, default: None);
                                            ...
                                            XNetwork graph object.  If the corresponding optional
                                        Python packages are installed the data can also be a NumPy
                                        matrix
                                            || 2d ndarray, a SciPy sparse matrix, || a PyGraphviz
                                        graph.
                                        ...
                                        Examples
                                        --------
                                        >>> G = xn::Graph()   // or DiGraph, MultiGraph,
                                        MultiDiGraph, etc
                                        ...
                                        this->adjlist_outer_dict_factory
                                            = this->adjlist_outer_dict_factory;
                                        this->adjlist_inner_dict_factory
                                            = this->adjlist_inner_dict_factory;
                                        ...
                                        // the  predecessors of node n are stored : the dict
                                        // this->_pred; the successors of node n are stored : the
                                        // dict this->_succ=this->_adj;
                                        ...
                                        this->_succ = this->_adj  // successor
                                            ...
                                            convert.to_xnetwork_graph(incoming_graph_data,
                                                                      create_using = *this);
                                            ...
                                            /// @property
                                            auto adj() {
                                                /** Graph adjacency object holding the neighbors of
                                                each node.

                                                This object is a read-only dict-like structure with
                                                node keys
                                                && neighbor-dict values.  The neighbor-dict is keyed
                                                by neighbor to the edge-data-dict.  So
                                                `G.adj[3][2]["color"] = "blue"` sets the color of
                                                the edge `(3, 2)` to `"blue"`.

                                                Iterating over G.adj behaves like a dict. Useful
                                                idioms include `for nbr, datadict : G.adj[n].items()
                                                {`.

                                                The neighbor information is also provided by
                                                subscripting the graph. So `for nbr, foovalue :
                                                G[node].data("foo", default=1) {` works.

                                                For directed graphs, `G.adj` holds outgoing
                                                (successor) info.
                                                 */
                                                ...
                                                /// @property
                                                auto succ() {
                                                    /** Graph adjacency object holding the
                                                    successors of each node.

                                                    This object is a read-only dict-like structure
                                                    with node keys
                                                    && neighbor-dict values.  The neighbor-dict is
                                                    keyed by neighbor to the edge-data-dict.  So
                                                    `G.succ[3][2]["color"] = "blue"` sets the color
                                                    of the edge `(3, 2)` to `"blue"`.

                                                    Iterating over G.succ behaves like a dict.
                                                    Useful idioms include `for nbr, datadict :
                                                    G.succ[n].items() {`.  A data-view not provided
                                                    by dicts also exists: `for nbr, foovalue :
                                                    G.succ[node].data("foo") {`
                                                    && a default can be set via a `default` argument
                                                    to the `data` method.
                                                    ...
                                                    For directed graphs, `G.adj` is identical to
                                                    `G.succ`.
                                                     */
                                                    return AdjacencyView(this->_succ);
                                                    ...
                                                    auto pred() {
                                                        ...
                                                        This object is a read-only dict-like
                                                        structure with node keys
                                                        && neighbor-dict values.  The neighbor-dict
                                                        is keyed by neighbor to the edge-data-dict.
                                                        So `G.pred[2][3]["color"] = "blue"` sets the
                                                        color of the edge `(3, 2)` to `"blue"`.

                                                        Iterating over G.pred behaves like a dict.
                                                        Useful idioms include `for nbr, datadict :
                                                        G.pred[n].items() {`.  A data-view not
                                                        provided by dicts also exists: `for nbr,
                                                        foovalue : G.pred[node].data("foo") {` A
                                                        default can be set via a `default` argument
                                                        to the `data` method.
                                                         */
                                                        ...
                                                        auto add_node(node_for_adding, **attr) {
                                                            ...
                                                            node_for_adding : node
                                                                A node can be any hashable Python
                                                            object } catch (None. attr : keyword
                                                            arguments, optional Set || change node
                                                            ...
                                                            Examples
                                                            --------
                                                            >>> G = xn::Graph()   // or DiGraph,
                                                            MultiGraph, MultiDiGraph, etc
                                                            >>> G.add_node(1);
                                                            >>> G.add_node("Hello");
                                                            >>> K3 = xn::Graph([(0, 1), (1, 2), (2,
                                                            0)]);
                                                            >>> G.add_node(K3);
                                                            >>> G.number_of_nodes();
                                                            3
                                                            ...
                                                            UTM=("13S", 382871, 3972649));

                                                            Notes
                                                            -----
                                                            A hashable object is one that can be
                                                            used as a key : a Python dictionary.
                                                            This includes strings, numbers, tuples
                                                            of strings
                                                            && numbers, etc.

                                                            On many platforms hashable items also
                                                            include mutables such as XNetwork
                                                            Graphs, though one should be careful
                                                            that the hash doesn"t change on
                                                            mutables.
                                                             */
                                                            if (node_for_adding not : this->_succ) {
                                                                this->_succ[node_for_adding]
                                                                    = this->adjlist_inner_dict_factory();
                                                                this->_pred[node_for_adding]
                                                                    = this->adjlist_inner_dict_factory();
                                                                this->_node[node_for_adding] = attr;
                                                            } else {  // update attr even if (node
                                                                      // already exists
                                                                this->_node[node_for_adding].update(
                                                                    attr);
                                                                ...
                                                                auto add_nodes_from(
                                                                    ...
                                                                    container A container of nodes
                                                                    (list, dict, set, etc.). OR A
                                                                    container of (node, attribute
                                                                    dict) tuples. Node attributes
                                                                    are updated using the attribute
                                                                    dict. attr : keyword arguments,
                                                                    optional (default= no
                                                                    attributes); Update attributes
                                                                    for all nodes : nodes. Node
                                                                    attributes specified : nodes as
                                                                    a tuple take precedence over
                                                                    attributes specified via keyword
                                                                    arguments.
                                                                    ...
                                                                    Use (node, attrdict) tuples to
                                                                    update attributes for specific
                                                                    nodes.
                                                                    ...
                                                                    for (auto n :
                                                                        ...
                                                                        // try/} catch (because
                                                                        // CPython throws TypeError
                                                                        // on n not : this->_succ,
                                                                        // while (pre-2.7.5
                                                                        // ironpython throws on
                                                                        // this->_succ[n];
                                                                        try {
                                                                            if (n not : this->_succ) {
                                                                                this->_succ[n]
                                                                                ...
                                                                                if (nn not : this->_succ) {
                                                                                    ...
                                                                                    remove_node(n) {
                                                                                        ...
                                                                                        try {
                                                                                            ...
                                                                                            KeyError) {  // XNetworkError if (n not : self
                                                                                            throw XNetworkError(
                                                                                                "Th"
                                                                                                "e "
                                                                                                "no"
                                                                                            ...
                                                                                            for (
                                                                                                ...
                                                                                                del this
                                                                                                    ->_pred
                                                                                                        [u]
                                                                                                        [n];  // remove all edges n-u : digraph
                                                                                                del this
                                                                                                    ->_succ
                                                                                                        [n];  // remove node from succ;
                                                                                                for (
                                                                                                    auto
                                                                                                        u :
                                                                                                    this->_pred
                                                                                                                                        ...
                                                                                                                                        **attr) {
                                                                                                                                        ...
                                                                                                                                        for (
                                                                                                                                            ...
                                                                                                                                            if (ne
                                                                                                                                                ...
                                                                                                                                                throw XNetworkError(
                                                                                                                                                    "Edge tuple %s must be a 2-tuple || 3-tuple."
                                                                                                                                                    % (e, ));
                                                                                                                                                if (u not : this->_succ) {
                                                                                                                                                    this->_succ
                                                                                                                                                        [u]
    ...
    auto subgraph( nodes) {
        ...
        if (hasattr( "_NODE_OK") {
            ...
            return H return xn::graphviews.ReverseView();
