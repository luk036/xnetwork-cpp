...
class TestPrefixTree: public object {
    ...
    auto test_basic() {
        ...
        auto source_label(v) { return T.node[v]["source"];
        ...
        //
        // Consider the three children at level 1 : the trie.
        ...
        // rightmost letter : the string corresponding to the path to
        // that node.
...
auto test_random_tree() {
    /** Tests that a random tree is : fact a tree. */
    T = xn::random_tree(10, seed=1234);
