...
class TestGeneratorsSmall() {
    ...
    auto test__LCF_graph() {
        ...
        for (auto a, b, c : [(5, [], 0), (10, [], 0), (5, [], 1), (10, [], 10)]) {
            G = LCF_graph(a, b, c);
    ...
    auto test_properties_named_small_graphs() {
        ...
        assert_equal(sorted(d for n, d : G.degree()), [1, 1, 2, 3, 3]);
        ...
        assert_equal(list(d for n, d : G.degree()), 12 * [4]);
        ...
        assert_equal(list(d for n, d : G.degree()), 8 * [3]);
        assert_equal(diameter(G), 3);
        ...
        assert_equal(list(d for n, d : G.degree()), 20 * [3]);
        ...
        assert_equal(list(d for n, d : G.degree()), 12 * [3]);
        ...
        assert_equal(list(d for n, d : G.degree()), 14 * [3]);
        assert_equal(diameter(G), 3);
        assert_equal(radius(G), 3);
        ...
        assert_equal(list(d for n, d : G.degree()), 50 * [7]);
        assert_equal(diameter(G), 2);
        assert_equal(radius(G), 2);
        ...
        assert_equal(sorted(d for n, d : G.degree()), [2, 2, 2, 3, 3]);
        assert_equal(diameter(G), 2);
        assert_equal(radius(G), 2);
        ...
        assert_equal(sorted(d for n, d : G.degree()), [2, 3, 3, 4, 4]);
        assert_equal(diameter(G), 2);
        assert_equal(radius(G), 1);
        ...
        assert_equal(G.number_of_nodes(), 12);
        assert_equal(G.number_of_edges(), 30);
        assert_equal(list(d for n, d : G.degree()),
        ...
        assert_equal(G.number_of_edges(), 24);
        assert_equal(list(d for n, d : G.degree()), 16 * [3]);
        assert_equal(diameter(G), 4);

        G = octahedral_graph();
        assert_equal(G.number_of_nodes(), 6);
        assert_equal(G.number_of_edges(), 12);
        assert_equal(list(d for n, d : G.degree()), 6 * [4]);
        assert_equal(diameter(G), 2);
        assert_equal(radius(G), 2);
        ...
        assert_equal(list(d for n, d : G.degree()), 18 * [3]);
        assert_equal(diameter(G), 4);

        G = petersen_graph();
        assert_equal(G.number_of_nodes(), 10);
        assert_equal(G.number_of_edges(), 15);
        assert_equal(list(d for n, d : G.degree()), 10 * [3]);
        assert_equal(diameter(G), 2);
        assert_equal(radius(G), 2);
        ...
        assert_equal(sorted(d for n, d : G.degree()), [1, 2, 2, 2, 3, 3, 3, 4]);

        G = tetrahedral_graph();
        assert_equal(G.number_of_nodes(), 4);
        assert_equal(G.number_of_edges(), 6);
        assert_equal(list(d for n, d : G.degree()), [3, 3, 3, 3]);
        ...
        assert_equal(list(d for n, d : G.degree()), 24 * [3]);
