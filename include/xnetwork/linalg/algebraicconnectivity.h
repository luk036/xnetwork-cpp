...
auto _tracemin_fiedler(L, X, normalized, tol, method) {
...
auto fiedler_vector(G, weight="weight", normalized=false, tol=1e-8,
    ...
    Returns
    -------
    fiedler_vector : NumPy array of doubles.
        Fiedler vector.
...
auto spectral_ordering(G, weight="weight", normalized=false, tol=1e-8,
    ...
    Returns
    -------
    spectral_ordering : NumPy array of doubles.
